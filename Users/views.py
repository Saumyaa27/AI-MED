...
from .models import User,Patient,Doctor,Treatment,Disease,Specialization,Symptom,QnA
from .forms import  Register_Doc,Register_Patient, LoginUserForm, RegisterUserForm, Forgot_email_form,Forgot_Password_Form, Prescription,Symptoms,QuestionForm, AnswerForm, AppointmentForm
